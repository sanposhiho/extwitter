defmodule ExTwitter.Behaviour do
  ...
  @callback authorize_url(String.t()) :: {:ok, String.t()} | {:error, atom()}
  @callback authorize_url(String.t(), map()) :: {:ok, String.t()} | {:error, atom()}
  @callback authenticate_url(String.t(), map()) :: {:ok, String.t()} | {:error, atom()}
  @callback authenticate_url(String.t()) :: {:ok, String.t()} | {:error, atom()}
